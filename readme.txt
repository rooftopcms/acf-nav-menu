...
Contributors: Faison
Tags: Advanced Custom Fields, acf, acf5, custom fields, admin, menu, nav menu, navigation
...
Add-On plugin for Advanced Custom Fields (ACF) that adds a 'Nav Menu' Field type, based on Advanced Custom Fields: Nav Menu Field by Faison Zutavern
